...
class AnnotationData {
  ...
  bool operator ==(Object other) {
    if (other is! AnnotationData || other.runtimeType != runtimeType) {
      return false;
    }
...
class PdfAnnotationsApi {
  /// Constructor for [PdfAnnotationsApi].  The [binaryMessenger] named argument is
  ...
  Future<bool> registerFonts(List<String> fontList) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[fontList]);
  ...
  Future<bool> addAnnotations(AnnotationData annotationData) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[annotationData]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
